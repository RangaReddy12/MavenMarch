...
public class CommonFunction {
	...
	public static WebDriver startBrowser() throws Throwable
	{
		...
		{
			System.setProperty("webdriver.chrome.driver", "G:\\9OClock_Selenium\\ERP_StockMaven\\CommonDrivers\\chromedriver.exe");
			driver = new ChromeDriver();
			driver.manage().window().maximize();
		}
		else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox"))
		{
			System.setProperty("webdriver.gecko.driver", "G:\\9OClock_Selenium\\ERP_StockMaven\\CommonDrivers\\geckodriver.exe");
...
public static void captureData(WebDriver driver,String locatortype,String locatorvalue)throws Throwable
{
	...
	FileWriter fw = new FileWriter("G:\\9OClock_Selenium\\ERP_StockMaven\\CaptureData\\supplier.txt");
...
public static void stableValidation(WebDriver driver,String columndata)throws Throwable
{
	...
	FileReader fr= new FileReader("G:\\9OClock_Selenium\\ERP_StockMaven\\CaptureData\\supplier.txt");
