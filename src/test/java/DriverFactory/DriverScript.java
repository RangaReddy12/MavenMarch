...
public class DriverScript {
	...
	ExtentTest test;
	String inputpath="G:\\9OClock_Selenium\\ERP_StockMaven\\TestInput\\HybridInput.xlsx";
	String outputpath="G:\\9OClock_Selenium\\ERP_StockMaven\\Testoutput\\HybridResults.xlsx";
...
report= new ExtentReports("./ExtententReports//"+TCModule+CommonFunction.generateDate()+".html");				
